...
export const UnboundGraphSettings = ({
  ...
  >
    ...
    <div
      className="ColJust"
      style={{ flexGrow: 5, border: 'solid black 1pt', margin: 2 }}
    >
    ...
    >
      ...
      <div style={{ flexGrow: 5, padding: '8pt' }}>
        <InputRange
          ...
          minValue={1}
          maxValue={50}
          formatLabel={(v: number, t: string) =>
            t === 'value' ? v.toString().substr(0, 5) : ''
          }
          onChange={onScaleChange}
          onChangeComplete={onScaleChange}
        />
      </div>
    </div>
  </div>
